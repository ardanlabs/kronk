...
const tictactoeExample = `package main
    ...
    <div>
      ...
      <div className="doc-layout">
        <div className="doc-content">
          ...
          <div className="card" id="example-tictactoe">
            <h3>Tictactoe</h3>
            <p className="doc-description"></p>
            <CodeBlock code={tictactoeExample} language="go" />
          </div>
          ...
          <div className="doc-sidebar-content">
            <div className="doc-index-section">
              ...
              <ul>
                ...
                <li><a href="#example-tictactoe">Tictactoe</a></li>
