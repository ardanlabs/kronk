...
func newMalina(mp models.Path) (*malina.Malina, error) {
	...
	fmt.Println("- model version     :", mi.ModelVersion)
...
const malinaS2vExample = `// This example generates a Wan2.2 S2V video from a source image and a WAV
    ...
    <div>
      ...
      <div className="doc-layout">
        <div className="doc-content">
          ...
          <div className="card" id="example-malina-s2v">
            <h3>Malina-S2v</h3>
            <p className="doc-description">This example generates a Wan2.2 S2V video from a source image and a WAV</p>
            <CodeBlock code={malinaS2vExample} language="go" />
          </div>
          ...
          <div className="doc-sidebar-content">
            <div className="doc-index-section">
              ...
              <ul>
                ...
                <li><a href="#example-malina-s2v">Malina-S2v</a></li>
