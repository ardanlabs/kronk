...
const buckyStreamExample = `// This example shows the streaming transcription API surface for the
      ...
      <div className="doc-layout">
        <div className="doc-content">
          ...
          <div className="card" id="example-bucky-stream">
            <h3>Bucky-Stream</h3>
            <p className="doc-description">This example shows the streaming transcription API surface for the</p>
