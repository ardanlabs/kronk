...
const diagnoseExample = `// This example is a diagnostic ("hack") tool. The goal right now is just to
    ...
    <div>
      ...
      <div className="doc-layout">
        <div className="doc-content">
          ...
          <div className="card" id="example-diagnose">
            <h3>Diagnose</h3>
            <p className="doc-description">This example is a diagnostic ("hack") tool. The goal right now is just to</p>
            <CodeBlock code={diagnoseExample} language="go" />
          </div>
          ...
          <div className="doc-sidebar-content">
            <div className="doc-index-section">
              ...
              <ul>
                ...
                <li><a href="#example-diagnose">Diagnose</a></li>
