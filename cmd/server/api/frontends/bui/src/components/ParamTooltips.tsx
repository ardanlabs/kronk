...
export const PARAM_TOOLTIPS = {
  ...
  runningModelMTPDraft: 'Fixed number of candidate tokens the loaded MTP model attempts to draft per speculative round. A dash means the model is not using MTP.',
