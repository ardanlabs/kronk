...
export const PARAM_TOOLTIPS = {
  ...
  imcCheckpointContext: 'Physical context retained at the previous complete user-turn boundary. Kronk can restore this checkpoint when later template output no longer matches the current snapshot.',
