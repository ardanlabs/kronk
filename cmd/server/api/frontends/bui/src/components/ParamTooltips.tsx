...
export const PARAM_TOOLTIPS = {
  ...
  mtpNDraft: 'Starting number of draft tokens per round for the auto-detected MTP head baked into this model. Kronk may benchmark lower counts and lock the fastest one for the loaded model. Leave empty to use the default of 3.',
  ...
  runningModelMTPDraft: 'Current model-level MTP draft count and policy state. Observing means Kronk is evaluating acceptance at the configured count; calibrating means it is interleaving throughput trials; locked means the displayed count will be used until the model is unloaded.',
