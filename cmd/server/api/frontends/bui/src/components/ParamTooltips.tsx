...
export const PARAM_TOOLTIPS = {
  ...
  nthreads: 'Number of CPU threads used for single-token generation. More threads can speed up CPU-bound work but may cause contention on busy systems. 0 or empty = at least 4, or the number of logical CPUs when higher.',
  nthreadsBatch: 'Number of CPU threads used for prompt processing and other multi-token batches. 0 or empty = at least 4, or the number of logical CPUs when higher.',
