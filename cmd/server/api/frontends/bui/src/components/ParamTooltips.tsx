...
export const PARAM_TOOLTIPS = {
  ...
  imcTotalAllocated: 'Combined rolling-snapshot and user-turn-checkpoint allocation. This is storage accounting and can exceed the model context window because the snapshots are independent.',
