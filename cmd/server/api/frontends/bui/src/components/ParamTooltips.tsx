...
export const PARAM_TOOLTIPS = {
  ...
  imcTotalAllocated: 'Retained high-water context allocated to this session. It does not decrease when the session is reused with a smaller context. Internal fallback storage is not included.',
