      ...
      },
      {
        ...
        items: [
          ...
          { page: 'docs-sdk-examples', label: 'Examples', children: [
            ...
            { page: 'docs-sdk-examples', label: 'Bucky-Diar', hash: 'example-bucky-diar' },
            ...
            { page: 'docs-sdk-examples', label: 'Malina-Adetailer', hash: 'example-malina-adetailer' },
