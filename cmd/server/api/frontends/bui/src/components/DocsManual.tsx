...
models:
  ...
  nseq-max: 4`}</code></pre>
          ...
          <p><img src="https://raw.githubusercontent.com/ardanlabs/kronk/main/.manual/images/chapter-03/dense-moe-hybrid-inference.svg" alt="Dense, Mixture-of-Experts, and hybrid inference compared" /></p>
...
└───────────────┘       │                                    │
          ...
          <p><img src="https://raw.githubusercontent.com/ardanlabs/kronk/main/.manual/images/chapter-04/prefill-batching.svg" alt="The two prefill phases: restore reusable IMC state, then compute missing request state" /></p>
...
Next stable rendering retroactively changes an assistant turn:
  reject Current -> restore System -> recompute after System -> replace Current`}</code></pre>
          ...
          <p><img src="https://raw.githubusercontent.com/ardanlabs/kronk/main/.manual/images/chapter-05/imc-session-selection.svg" alt="IMC cache population and session selection" /></p>
