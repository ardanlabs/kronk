	...
	DraftDisableReason  string  \`json:"draft_disable_reason,omitempty"\`
          ...
          <div className="card" id="methods">
            ...
            <div className="doc-section" id="method-config-flashattention">
              ...
              <p className="doc-description">FlashAttention returns the configured flash attention mode. An unset value preserves the existing default of enabled.</p>
            </div>
