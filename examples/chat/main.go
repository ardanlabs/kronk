...
func chat(krn *kronk.Kronk) error {
	...
	messages = append(messages,
		model.TextMessage(model.RoleSystem, "You are Qwen, a large language model trained by Tongyi Lab. You are designed to help users answer questions, create content, and provide information in a helpful and accurate manner. Always follow the user's instructions carefully and respond with clear, concise, and well-structured answers."),
	)
