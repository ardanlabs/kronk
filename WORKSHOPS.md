...
- Use the Kronk SDK to build robust Go applications that interact with open source models
- Use Kronk to build a bare minimum model server with an OpenAI-compatible chat completions API
