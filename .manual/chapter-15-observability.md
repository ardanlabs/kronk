...
| IMC | `imc_session_state`, `imc_session_context_tokens`, `imc_session_latest_request_context_tokens`, `imc_session_peak_context_tokens`, `imc_snapshot_skipped_total`, `imc_pure_hit_stale_session_total` |
...
System caches are model-owned rather than working-session metrics. Their live
state is available on the **System Caches** tab of the BUI **IMC Sessions**
page. The Current values can move before the latest-request values update:
