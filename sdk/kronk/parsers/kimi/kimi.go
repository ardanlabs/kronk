...
func identifiesK3(value string) bool {
	return strings.Contains(value, "kimi-k3") ||
		strings.Contains(value, "kimi_k3") ||
		strings.Contains(value, "kimi k3")
}
