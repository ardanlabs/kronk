...
func TestSuite(t *testing.T) {
	testlib.WithModel(t, testlib.CfgMoEVisionIMC(), func(t *testing.T, krn *kronk.Kronk) {
...
// and decodeMediaIntoCache in startSlot on a MoE architecture.
