...
func TestSuite(t *testing.T) {
	testlib.WithModel(t, testlib.CfgThinkToolChat(), func(t *testing.T, krn *kronk.Kronk) {
		...
		t.Run("ArrayFormatChat", func(t *testing.T) { testChat(t, krn, testlib.DChatNoToolArray, false) })
		t.Run("ArrayFormatStreamingChat", func(t *testing.T) { testChatStreaming(t, krn, testlib.DChatNoToolArray, false) })
